...
const Header = ({
  ...
  return (
    <div className='bg-[#f7fdfd]'>
          ...
          <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
            ...
            <div>
              <CustomButton
                ...
                title='Search'
                containerStyles={
                  "text-white py-2 md:py3 px-3 md:px-10 focus:outline-none bg-gradient-to-r from-purple-500 to-purple-900 rounded-full md:rounded-md text-sm md:text-base"
                }
              />
            </div>
          </div>
      ...
      <img src={Logo} className='object-contain rounded-full mt-10' />
        </div>
      </div>
    </div>
  );
